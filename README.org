...
* News
** Thu 21 Nov 2019 
Added =Named_Assert_Type= type. See example section.
** Fri 01 Nov 2019
...
** New examples (Thu 21 Nov 2019)

The =Named_Assert_Type= type has been added it allows to control
parameters. A usage example is as follows:
